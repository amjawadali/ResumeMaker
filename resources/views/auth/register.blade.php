<x-guest-layout>
    <div style="text-align: center; margin-bottom: 2rem;">
        <h2 style="font-family: var(--font-heading); font-size: 1.75rem; font-weight: 700; background: var(--primary-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Create Account</h2>
        <p style="color: var(--text-muted); font-size: 0.95rem;">Join us to build your professional future</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-input-error :messages="$errors->get('name')" class="mt-2" style="color: #f87171; font-size: 0.85rem;" />
        </div>
        ...
        <div class="mt-4" style="margin-top: 1rem;">
            ...
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" style="color: #f87171; font-size: 0.85rem;" />
        </div>
        ...
        <div style="text-align: center; margin-top: 1.5rem; font-size: 0.9rem; color: var(--text-muted);">
            ...
            <a href="{{ route('login') }}" class="auth-link" style="color: #a855f7; font-weight: 500;">Log in</a>
        </div>
    </form>
</x-guest-layout>
