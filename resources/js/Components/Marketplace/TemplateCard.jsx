...
import { Eye, Plus, Sparkles, User, Star, TrendingUp, ShieldCheck, Heart } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            {template.status === 'approved' && (
                <div className="absolute top-4 right-14 z-10 p-2 bg-white/10 backdrop-blur-md rounded-full text-white/50 border border-white/10" title="Community Verified">
            ...
            <button
                ...
                className={`absolute top-4 right-4 z-10 p-2 backdrop-blur-md rounded-full border transition-all duration-300 ${
                    isFavorited
                        ? 'bg-red-500/20 border-red-500/30 text-red-400'
                        : 'bg-white/10 border-white/10 text-white/50 hover:text-red-400 hover:bg-red-500/10'
                }`}
